<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageRoles.aspx.cs" Inherits="Promaneng_Ltd.Maintenance.ManageRoles" %>
     ...
     <div class="row">
        <div class="col-sm-12 table-responsive">
            ...
            <asp:GridView ID="grdUsers" runat="server" DataKeyNames="Id"
                 ...
                 ItemType="Promaneng_Ltd.Models.ApplicationUser"
